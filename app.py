...
'''Author: Ayush Sinha
If you find any error in this code then you can contact me sinhaayush0806@gmail.com'''  
...
class Weather(Tk):
    def __init__(self):
        ...
        self.iconbitmap(os.path.join(os.path.dirname(__file__), "Images", "weather_icon.ico"))
